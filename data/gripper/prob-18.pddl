(define (problem gripper_18_balls)
   (:domain gripper_typed)
   (:objects
   rooma roomb - room
   ball18 ball17 ball16 ball15 ball14 ball13 ball12 ball11 ball10 ball9 ball8 ball7 ball6 ball5 ball4 ball3 ball2 ball1 - ball
   left right - gripper
   )
   (:init
          (at_robby rooma)
